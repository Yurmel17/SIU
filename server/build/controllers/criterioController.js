...
class CriterioController {
    listar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const criterio = yield database_1.default.query("SELECT * FROM criterio_admision", [
                req.body,
            ]);
            res.json(criterio);
        });
    ...
    buscar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const criterio_admision = yield database_1.default.query("SELECT * FROM criterio_admision WHERE idCriterio_Admision = ?", [idCriterio_Admision]);
